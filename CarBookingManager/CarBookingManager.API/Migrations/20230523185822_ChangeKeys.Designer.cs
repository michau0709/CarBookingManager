...
namespace CarBookingManager.API.Migrations
{
    ...
    [Migration("20230523185822_ChangeKeys")]
            ...
            modelBuilder.Entity("CarBookingManager.API.Models.Reservation", b =>
                {
                    ...
                    b.Property<string>("CustomerPersonalNo")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ReservedCarRegistrationNo")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("CustomerPersonalNo");

                    b.HasIndex("ReservedCarRegistrationNo");
            ...
            modelBuilder.Entity("CarBookingManager.API.Models.Reservation", b =>
                {
                    b.HasOne("CarBookingManager.API.Models.Customer", "Customer")
                        ...
                        .HasForeignKey("CustomerPersonalNo");

                    b.HasOne("CarBookingManager.API.Models.Car", "ReservedCar")
                        .WithMany()
                        .HasForeignKey("ReservedCarRegistrationNo");
